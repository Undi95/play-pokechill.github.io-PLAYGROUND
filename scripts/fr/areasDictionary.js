...
// Weather / terrain / field buff names for format()
field.sunny = { rename: `Sunny`, renameFR: `Ensoleillement` }
field.rainy = { rename: `Rainy`, renameFR: `Pluie` }
field.sandstorm = { rename: `Sandstorm`, renameFR: `Tempête de Sable` }
field.hail = { rename: `Hail`, renameFR: `Grêle` }
field.foggy = { rename: `Foggy`, renameFR: `Brouillard` }
field.electricTerrain = { rename: `Electric Terrain`, renameFR: `Champ Électrifié` }
field.grassyTerrain = { rename: `Grassy Terrain`, renameFR: `Champ Herbu` }
field.mistyTerrain = { rename: `Misty Terrain`, renameFR: `Champ Brumeux` }
field.psychicTerrain = { rename: `Psychic Terrain`, renameFR: `Champ Psychique` }
field.trickRoom = { rename: `Trick Room`, renameFR: `Distorsion` }
field.weirdRoom = { rename: `Weird Room`, renameFR: `Zone Étrange` }
field.crossRoom = { rename: `Cross Room`, renameFR: `Salle Croix` }
field.lightScreen = { rename: `Light Screen`, renameFR: `Mur Lumière` }
field.safeguard = { rename: `Safeguard`, renameFR: `Rune Protect` }
field.reflect = { rename: `Reflect`, renameFR: `Reflet` }


//positive
field.simpleAura = {
    renameFR: `Aura Simple`,
...
field.serendipity = {
    renameFR: `Sérendipité`,
    info : function() { return t_ui('skillSerendipityDesc')},
    tier: 1
}

field.harshSun = {
    rename: `Harsh Sun`,
    renameFR: `Soleil Ardent`,
    info : function() { return `Permanent <strong data-buff="sunny" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("fire")}">${format('sunny')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}

field.thickFog = {
    rename: `Foggy`,
    renameFR: `Brouillard Dense`,
    info : function() { return `Permanent <strong data-buff="foggy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ghost")}">${format('foggy')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}

field.fierceHail = {
    rename: `Hail`,
    renameFR: `Grêle Violente`,
    info : function() { return `Permanent <strong data-buff="hail" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ice")}">${format('hail')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}

field.coarseSandstorm = {
    rename: `Sandstorm`,
    renameFR: `Tempête de Sable Violente`,
    info : function() { return `Permanent <strong data-buff="sandstorm" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("ground")}">${format('sandstorm')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}

field.heavyRain = {
    rename: `Rainy`,
    renameFR: `Pluie Torrentielle`,
    info : function() { return `Permanent <strong data-buff="rainy" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("water")}">${format('rainy')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}
...
field.mistyField = {
    ...
    info : function() { return `Permanent <strong data-buff="mistyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("psychic")}">${format('mistyTerrain')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}
...
field.grassyField = {
    ...
    info : function() { return `Permanent <strong data-buff="grassyTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("grass")}">${format('grassyTerrain')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}
...
field.electricField = {
    ...
    info : function() { return `Permanent <strong data-buff="electricTerrain" ><strong  style="color:white;cursor:help;padding: 0.1rem 0.7rem; border-radius: 0.2rem; font-size:1.1rem; width: auto; background: ${returnTypeColor("electric")}">${format('electricTerrain')}</strong></strong> ${t_ui('weatherSuffix')}`},
    tier: 1
}
...
field.trickField = {
    renameFR: `Champ de Distorsion`,
    info : function() { return t_ui('fieldTrickRoomDesc')},
    tier: 2
}
 
field.reverseField = {
    renameFR: `Champ Inversé`,
    info : function() { return t_ui('fieldReverseFieldDesc')},
    tier: 2,
    chance: 0.5
}

field.averageTime = {
    renameFR: `Temps Moyen`,
    info : function() { return t_ui('fieldAverageTimeDesc')},
    tier: 2
}

field.noMercy = {
    renameFR: `Sans Pitié`,
    info : function() { return t_ui('fieldNoMercyDesc')},
    tier: 2
}
...
field.deltaStream = {
    renameFR: `Courant Delta`,
    info : function() { return t_ui('fieldDeltaStreamDesc')},
    tier: 3
}

field.stealthRocks = {
    renameFR: `Piège de Roc`,
    info : function() { return t_ui('fieldStealthRocksDesc')},
    tier: 3
}

field.heavyWeather = {
    renameFR: `Météo Lourde`,
    info : function() { return t_ui('fieldHeavyWeatherDesc')},
    tier: 3
}

field.ironBody = {
    renameFR: `Corps de Fer`,
    info : function() { return t_ui('fieldIronBodyDesc')},
    tier: 3
}
...
field.wonderWard = {
    renameFR: `Gardien Merveilleux`,
    info : function() { return t_ui('fieldWonderWardDesc')},
    tier: 4
}

field.neutralisingGas = {
    renameFR: `Gaz Neutralisant`,
    info : function() { return t_ui('fieldNeutralisingGasDesc')},
    tier: 4
}


field.weakeningCurse = {
    renameFR: `Malédiction Affaiblissante`,
    info : function() { return t_ui('fieldWeakeningCurseDesc')},
    tier: 4
}

field.fatiguingCurse = {
    renameFR: `Malédiction Fatiguante`,
    info : function() { return t_ui('fieldFatiguingCurseDesc')},
    tier: 4
}

field.unnerve = {
    renameFR: `Trouble`,
    info : function() { return t_ui('fieldUnnerveDesc')},
    tier: 4
}


field.firePledge = {
    renameFR: `Feu Serment`,
    info : function() { return t_ui('skillFirePledgeDesc')},
    tier: 4,
    chance: 0
}

field.fightingPledge = {
    renameFR: `Combat Serment`,
    info : function() { return t_ui('skillFightingPledgeDesc')},
    tier: 4,
    chance: 0
}

field.darkPledge = {
    renameFR: `Ténèbres Serment`,
    info : function() { return t_ui('skillDarkPledgeDesc')},
    tier: 4,
    chance: 0
}

field.dragonPledge = {
    renameFR: `Dragon Serment`,
    info : function() { return t_ui('skillDragonPledgeDesc')},
    tier: 4,
    chance: 0
}

field.fairyPledge = {
    renameFR: `Fée Serment`,
    info : function() { return t_ui('skillFairyPledgeDesc')},
    tier: 4,
    chance: 0
}

field.rockPledge = {
    renameFR: `Roche Serment`,
    info : function() { return t_ui('skillRockPledgeDesc')},
    tier: 4,
    chance: 0
}

field.electricPledge = {
    renameFR: `Électrique Serment`,
    info : function() { return t_ui('skillElectricPledgeDesc')},
    tier: 4,
    chance: 0
}

field.steelPledge = {
    renameFR: `Acier Serment`,
    info : function() { return t_ui('skillSteelPledgeDesc')},
    tier: 4,
    chance: 0
}

field.grassPledge = {
    renameFR: `Plante Serment`,
    info : function() { return t_ui('skillGrassPledgeDesc')},
    tier: 4,
    chance: 0
}

field.waterPledge = {
    renameFR: `Eau Serment`,
    info : function() { return t_ui('skillWaterPledgeDesc')},
    tier: 4,
    chance: 0
}

field.IcePledge = {
    renameFR: `Glace Serment`,
    info : function() { return t_ui('skillIcePledgeDesc')},
    tier: 4,
    chance: 0
}

field.poisonPledge = {
    renameFR: `Poison Serment`,
    info : function() { return t_ui('skillPoisonPledgeDesc')},
    tier: 4,
    chance: 0
}

field.flyingPledge = {
    renameFR: `Vol Serment`,
    info : function() { return t_ui('skillFlyingPledgeDesc')},
    tier: 4,
    chance: 0
}

field.normalPledge = {
    renameFR: `Normal Serment`,
    info : function() { return t_ui('skillNormalPledgeDesc')},
    tier: 4,
    chance: 0
}

field.bugPledge = {
    renameFR: `Insecte Serment`,
    info : function() { return t_ui('skillBugPledgeDesc')},
    tier: 4,
    chance: 0
}

field.groundPledge = {
    renameFR: `Sol Serment`,
    info : function() { return t_ui('skillGroundPledgeDesc')},
    tier: 4,
    chance: 0
}

field.ghostPledge = {
    renameFR: `Spectre Serment`,
    info : function() { return t_ui('skillGhostPledgeDesc')},
    tier: 4,
    chance: 0
}

field.psychicPledge = {
    renameFR: `Psy Serment`,
    info : function() { return t_ui('skillPsychicPledgeDesc')},
    tier: 4,
    chance: 0
}
...
skill.ironWill = {
    renameFR: `Volonté de Fer`,
    info : function() { return t_ui('skillIronWillDesc')},
    effect : function () { moveBuff("wild","defup2",undefined,15) }
}

skill.ironSpirit = {
    renameFR: `Esprit de Fer`,
    info : function() { return t_ui('skillIronSpiritDesc')},
    effect : function () { moveBuff("wild","sdefup2",undefined,15) }
}

skill.omniboost = {
    renameFR: `Omniboost`,
    info : function() { return t_ui('skillOmniboostDesc')},
...
skill.electroblast = {
    renameFR: `Électroblast`,
    info : function() { return t_ui('skillElectroblastDesc')},
    effect : function () { moveBuff("wild",'paralysis',"team",10) }
}

skill.pyroblast = {
    renameFR: `Pyroblast`,
    info : function() { return t_ui('skillPyroblastDesc')},
    effect : function () { moveBuff("wild",'burn',"team",15) }
}

skill.cryoblast = {
    renameFR: `Cryoblast`,
    info : function() { return t_ui('skillCryoblastDesc')},
    effect : function () { moveBuff("wild",'freeze',"team",15) }
}

skill.toxiblast = {
    renameFR: `Toxiblast`,
    info : function() { return t_ui('skillToxiblastDesc')},
    effect : function () { moveBuff("wild",'poisoned',"team",15) }
}


skill.suddenDeath = {
    renameFR: `Mort Subite`,
    info : function() { return t_ui('skillSuddenDeathDesc')},
    effect : function () { pkmn[ team[exploreActiveMember].pkmn.id ].playerHp = 0; updateTeamPkmn() }
}

skill.demoralisingRoar = {
    renameFR: `Rugissement Démoralisant`,
    info : function() { return t_ui('skillDemoralisingRoarDesc')},
    effect : function () {
...
areas.sinnohUndergroundI = {
    ...
    background : `cave`,
    level : wildAreaLevel2,
    unlockDescription : t_ui('defeatBrockToUnlock'),
...
areas.advancedDojoI = {
    ...
    type: `dungeon`,
    background : `gym`,
    unlockDescription : t_ui('defeatMistyToUnlock'),
...
areas.expertDojoI = {
    ...
    type: `dungeon`,
    background : `gym`,
    unlockDescription : t_ui('defeatPhoebeToUnlock'),
...
areas.victoryRoadI = {
    ...
    unlockDescription : t_ui('defeatEliteTrainerCynthiaToUnlock'),
...
areas.glisteringCaveI = {
    ...
    level : 95,
    difficulty: 5,
    unlockDescription : t_ui('defeatUltraEntityLusamine'),
...
areas.sunkenTempleI = {
    ...
    level : 100,
    difficulty: 5,
    unlockDescription : t_ui('defeatPokemonProfessorOakToUnlock'),
...
areas.ceruleanCave = {
    ...
    difficulty: 5,
    uncatchable: true,
    unlockDescription : t_ui('defeatGeetaToUnlock'),
...
areas.eventMegaBlastoise = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/pokeflute.png"> ${format('pokeflute')}`})}`; },
...
areas.eventZapdos = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/epochFeather.png"> ${format('epochFeather')}`})}`; },
...
areas.eventMegaCamerupt = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/epochFeather.png"> ${format('epochFeather')}`})}`; },
...
areas.eventMegaRaichuX = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/pokeflute.png"> ${format('pokeflute')}`})}`; },
...
areas.eventGreatTusk = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/ancientOrchid.png"> ${format('ancientOrchid')}`})}`; },
...
areas.eventRoaringMoon = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/ancientOrchid.png"> ${format('ancientOrchid')}`})}`; },
...
areas.eventMegaGarchomp = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/primalEarth.png"> ${format('primalEarth')}`})}`; },
...
areas.eventMegaPinsir = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/primalEarth.png"> ${format('primalEarth')}`})}`; },
...
areas.eventMegaSceptile = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/steelKeystone.png"> ${format('steelKeystone')}`})}`; },
...
areas.eventRegirock = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/ancientKeystone.png"> ${format('ancientKeystone')}`})}`; },
...
areas.eventMegaMawile = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/ancientKeystone.png"> ${format('ancientKeystone')}`})}`; },
...
areas.eventRegieleki = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/steelKeystone.png"> ${format('steelKeystone')}`})}`; },
...
areas.eventNaganadel = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/aetherKeycard.png"> ${format('aetherKeycard')}`})}`; },
...
areas.eventGuzzlord = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/aetherKeycard.png"> ${format('aetherKeycard')}`})}`; },
...
areas.eventMegaMetagross = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/wormholeResidue.png"> ${format('wormholeResidue')}`})}`; },
...
areas.eventChienPao = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/wormholeResidue.png"> ${format('wormholeResidue')}`})}`; },
...
areas.eventMegaGengar = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/futureContraption.png"> ${format('futureContraption')}`})}`; },
...
areas.eventIronThorns = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/futureDisk.png"> ${format('futureDisk')}`})}`; },
...
areas.eventIronValiant = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/futureDisk.png"> ${format('futureDisk')}`})}`; },
...
areas.eventMegaBaxcalibur = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/futureContraption.png"> ${format('futureContraption')}`})}`; },
...
areas.eventMegaGallade = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/redChain.png"> ${format('redChain')}`})}`; },
...
areas.eventMegaLucario = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/redChain.png"> ${format('redChain')}`})}`; },
...
areas.eventMesprit = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/wisdomPetal.png"> ${format('wisdomPetal')}`})}`; },
...
areas.eventMegaPidgeot = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/wisdomPetal.png"> ${format('wisdomPetal')}`})}`; },
...
areas.dimensionRaid1 = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/megaShard.png"> ${format('megaShard')}`})}`; },
...
areas.dimensionRaid2 = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/megaPiece.png"> ${format('megaPiece')}`})}`; },
...
areas.dimensionRaid3 = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/megaChunk.png"> ${format('megaChunk')}`})}`; },
...
areas.dimensionRaid4 = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `<img src="img/items/megaCluster.png"> ${format('megaCluster')}`})}`; },
...
areas.seasonMarshadow = {
    ...
    unlockDescription : function() { return `${t_ui('requiresItemToEnter', {item: `x3 <img src="img/items/oldGateau.png"> ${format('oldGateau')}`})}`; },
...
for (const i in areas){
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel2) {
        areas[i].unlockDescription = t_ui('defeatBrockToUnlock')
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel3) {
        areas[i].unlockDescription = t_ui('defeatMistyToUnlock')
    ...
    if (areas[i].type == "wild" && areas[i].level == wildAreaLevel4) {
        areas[i].unlockDescription = t_ui('defeatPhoebeToUnlock')
